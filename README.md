...
<p align="left">
• <strong>Frontend:</strong> HTML5, CSS3, JavaScript (ES6+), React.js, Bootstrap 5, Tailwind CSS, Redux Toolkit<br>
• <strong>UI Libraries & Payment:</strong> Material-UI, Material-UI Icons, Stripe API, React Hook Form<br>
• <strong>State Management:</strong> Redux, Redux Toolkit, Context API<br>
• <strong>Tools & Version Control:</strong> Git, GitHub, Figma, VS Code, Chrome DevTools
</p>
